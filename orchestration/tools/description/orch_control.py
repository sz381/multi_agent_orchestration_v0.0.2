...
TOOL_DESCRIPTION = {
    ...
    "fanout_subagents": (
        ...
        "Call ONCE per round with ALL tasks — a second fanout_subagents call in the same "
        "round is merged by the system (prefer a single call; e.g. 5 independent tasks "
        "→ ONE call with 5 tasks, unique subagent_id each).\n"
        "Mutually exclusive with make_plan/edit_plan/delete_plan — at most one control tool per round.\n"
        "Parameters:\n"
